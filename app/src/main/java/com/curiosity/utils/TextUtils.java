...
//            CourseInfo info = new CourseInfo();
//            info.setName(str[0]);
//            String dayOfWeek = str[1].substring(0, 2);
//            info.setDayOfWeek(dayOfWeek);
//            String time = str[1].substring(3, str[1].indexOf("节"));
//            String times[] = time.split(",");
//            String timeFrom = times[0];
//            info.setTimeFrom(timeFrom);
//            String timeTo = times[times.length-1];
//            info.setTimeTo(timeTo);
//
//            String week[] = str[1].substring(str[1].indexOf("{")+2, str[1].indexOf("}")-1).split("-");
//            String weekFrom = week[0];
//            info.setWeekFrom(weekFrom);
//            String weekTo = week[1];
//            info.setWeekTo(weekTo);
//            info.setTechName(str[2]);
//            info.setClassNum(str[3]);
//            list.add(info);
//        }
        return list;
    }
